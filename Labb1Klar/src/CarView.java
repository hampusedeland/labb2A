...
public class CarView extends JFrame{
    ...
    CarController carC; //beroende Till CC

    DrawPanel drawPanel = new DrawPanel(X, Y-240); //beroende tyill drawpanel
    ...
    // Constructor
    public CarView(String framename, CarController cc){ //be till CC
        this.carC = cc;
    ...
    private void initComponents(String title) {
        ...
        this.add(drawPanel); // här adderar vi drawpanel
